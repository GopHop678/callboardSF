...
SECRET_KEY = 'django-insecure-=07ummej6ck6p&rio^y55(8+7rwnt(d(hi3*57mmc41$i5exg6'
...
CKEDITOR_5_CONFIGS = {
    ...
    'extends': {
        ...
        # ],
        'toolbar': [
            'bold', 'italic', 'underline', 'strikethrough', 'insertImage',
            'numberedList',
        ],
        'image': {
...
EMAIL_PORT = 465
EMAIL_HOST_USER = base_email
EMAIL_HOST_PASSWORD = ''
EMAIL_USE_TLS = False
EMAIL_USE_SSL = True

DEFAULT_FROM_EMAIL = base_email

SERVER_EMAIL = base_email
